...
public class KafkaConfig {
    ...
    private final static String cardTopic = "cards";
    private final static String accountTopic = "accounts";
    private final static String cardAccountTopicPrefix = "card-accounts-";

    @Bean
    public KafkaStreamsConfiguration kafkaStreamsConfigConfiguration() {
        return new KafkaStreamsConfiguration(
                Map.ofEntries(
                        entry(APPLICATION_ID_CONFIG, "card-account-divider"),
    ...
    public StreamsBuilderFactoryBean streamsBuilderFactoryBean(KafkaStreamsConfiguration kafkaStreamsConfigConfiguration)
        ...
        streamsBuilderFactoryBean.setInfrastructureCustomizer(new CustomInfrastructureCustomizer(cardTopic, accountTopic, cardAccountTopicPrefix));
